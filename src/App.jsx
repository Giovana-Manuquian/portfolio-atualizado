...
const Portfolio = () => {
  ...
  const projects = [
    ...
    {
      id: 4,
      title: "Plataforma de Agendamento Full-Stack",
      category: "fullstack",
      tech: ["Next.js", "Nest.js", "Prisma", "TypeScript", "PostgreSQL"],
      description: "Solução robusta desenvolvida para centralizar a gestão de agendamentos e serviços. O projeto segue um roadmap de desenvolvimento ativo, focado em melhorias contínuas de UX e módulos analíticos.",
      architecture: "Arquitetura desacoplada com NestJS (Back-end) e Next.js (Front-end), utilizando Prisma ORM para persistência de dados e TypeScript para garantir tipagem estática em ambos os serviços.",
      linkRep: "https://github.com/Giovana-Manuquian/agendamento-projeto-front-v2",
      linkLive: "https://agendamento-projeto-front-v2.vercel.app/"
    }
  ];
